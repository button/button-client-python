# Private Audience Model employs a Bloom Filter - a probablistic data
# structure that obfuscates identifier information and controls false positives.
#
# File adapted under the MIT license.
#
# Homepage:
...
class PrivateAudienceModel(object):
    FILE_FMT = b'<dQQQQ'
    ...
    def fromfile(cls, f, n=-1):
        ...
        filter.bitarray = bitarray(endian='little')
        if n > 0:
